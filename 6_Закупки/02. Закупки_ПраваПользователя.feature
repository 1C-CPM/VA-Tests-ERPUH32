...
Сценарий: 02.19. [Короткий процесс 2] ДД5(поставщик: Поставщик5), графики не используются
...
Сценарий: 02.16. [Короткий процесс 2] Заказ поставщику (по плану закупок), ДД5
...
Сценарий: 02.17. [Короткий процесс 2] ПТУ, ДД5
	...
	* Создаем ПТУ по заказу
		...
		Тогда открылось окно "Заказы поставщикам"
		И в таблице 'Список' я перехожу к строке:
			| "Валюта" | "Поставщик"  | "Сумма"        | "Хоз. операция"        |
			| "RUB"    | "Поставщик5" | "1 020 000,00" | "Закупка у поставщика" |

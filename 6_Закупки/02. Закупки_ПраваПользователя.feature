...
Сценарий: 02.09. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ПТУ(ДД2)
...
Сценарий: 02.11. [КОНКУРС] ЗП-3(зонтичная)
...
Сценарий: 02.12. [КОНКУРС] Протокол -> ДД3(ЗП3)
...
Сценарий: 02.13. [КОНКУРС] ПТУ(ДД3-1),Поставщик4
...
Сценарий: 02.14. [КОНКУРС] ПТУ(ДД3-2),Поставщик5
...
Сценарий: 02.16. [КП1: ПЗ -> Договор] Заказ поставщику(ДД4)
...
Сценарий: 02.17. [КП1: ПЗ -> Договор] ПТУ(ДД4)
...
Сценарий: 02.18. [КП1: ПЗ -> Договор] Возврат поставщику(ДД4)
...
Сценарий: 02.20. [КП2: ПЗ -> Заказ] Заказ поставщику(ДД5)
...
Сценарий: 02.21. [КП2: ПЗ -> Заказ] ПТУ(ДД5)

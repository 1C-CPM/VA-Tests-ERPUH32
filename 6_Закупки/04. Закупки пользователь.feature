...
Сценарий: 04.22. [ЗП -> Протокол -> Договор] ЗП
	...
	* Создаем лот
		...
		Тогда открылось окно "Организации"
		И в таблице 'Список' я перехожу к строке:
			| "Рабочее наименование"    | "Статус"    | "Тип организации"       |
			| "Королевство Гор и Долин" | "Действует" | "Налоговый резидент РФ" |
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Лоты*"
	...
	* Предложение участника 1
		...
		И в поле с именем 'УсловияПоставки' я ввожу текст "Тестовый пример 2"
		И я перехожу к следующему реквизиту
		И в поле с именем 'СрокиВыполненияДоговора' я ввожу текст "Тестовый пример 2"
		И я перехожу к следующему реквизиту
		И в поле с именем 'СрокПоставки' я ввожу текст "2"
		И я перехожу к следующему реквизиту
	...
	* Предложение участника 2
		...
		И в таблице 'УсловияПоНоменклатуреПоПериодам' я активизирую поле с именем 'УсловияПоНоменклатуреПоПериодамЦена'
		И в таблице 'УсловияПоНоменклатуреПоПериодам' я выбираю текущую строку
		И в таблице 'УсловияПоНоменклатуреПоПериодам' в поле с именем 'УсловияПоНоменклатуреПоПериодамЦена' я ввожу текст "90 000,00"
		И в таблице 'УсловияПоНоменклатуреПоПериодам' я завершаю редактирование строки
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна "Предложение участника (создание) *" в течение 20 секунд

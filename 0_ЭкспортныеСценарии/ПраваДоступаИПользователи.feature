...
Сценарий: Я нахожу или создаю пользователя 'TheUser' группа доступа 'TheProfile' группа 'TheGroup' почта "Mail"
	...
	* Ищем или создаем нужного пользователя
		...
		Если в таблице 'ПользователиСписок' количество строк "равно" 0 Тогда
			...
			И я заполняю электронную почту пользователя '[Mail]'
		Иначе

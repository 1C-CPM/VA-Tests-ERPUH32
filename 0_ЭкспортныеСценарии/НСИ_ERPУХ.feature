...
Сценарий: Я заполняю электронную почту пользователя 'ТекЭлектроннаяПочта'

	И в поле с именем 'КонтактнаяИнформацияПолеEmailПользователя' я ввожу текст '[ТекЭлектроннаяПочта]'
...
//		Тогда открылось окно "Вид номенклатуры (создание) *"
		И из выпадающего списка с именем 'ТипНоменклатуры' я выбираю точное значение '[ТекТип]'

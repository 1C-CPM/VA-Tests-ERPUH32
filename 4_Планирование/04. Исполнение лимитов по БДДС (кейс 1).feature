...
Сценарий: 04.01.3 Создаем Платежный документ
	...
	* Проверить наследование аналитик в ПП
		...
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			...
			Тогда таблица "РасшифровкаПлатежа" стала равной по шаблону:
				| 'N' | 'Сумма взаиморасчетов' | 'Документ планирования'                                                 | 'Аналитика 4'       | 'Элемент структуры задолженности' | 'Объект расчетов' | 'Аналитика 3'       | 'Договор'     | 'ЦФО'              | 'Валюта' | 'Аналитика 2'       | 'Поставщик'       | 'Комментарий' | 'Сумма (RUB)' | 'Аналитика 1' | 'Дата погашения' | 'Статья ДДС'    | 'Проект' | 'Аналитика 5'       | 'Аналитика 6'       |
